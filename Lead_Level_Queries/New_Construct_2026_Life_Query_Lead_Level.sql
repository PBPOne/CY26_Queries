...
p_motor AS (
    ...
    WHERE 
        ...
        AND Markettype IN (
            ...
            'North_Dealership',
            'South 1_Amit Bhadoria',
            'South 2_Amit Bhadoria',
...
(
select  
	 upper(p1.PartnerCode) as PartnerCode,p1.SellNowEnabled,p1.ComplianceCertified,Markettype, t1.*
...
select
PartnerCode,SellNowEnabled,ComplianceCertified,Markettype,IsComplianceN,compliance_flag,leadid,TotalPremium,APE,netpr,PaymentPeriodicity,PayoutProdCat,PayTerm,[Insurer Name], BookingDate,
